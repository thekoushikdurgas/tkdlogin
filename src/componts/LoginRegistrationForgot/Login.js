        ...
        <>
            ...
            <div className="lurcard login">
                ...
                <form className="logincl" id="loginid">
                    <div className="field">
                        <input type="text" name="loginemail" value={email} placeholder="Email Address eg. example@gmail.com" autoComplete="off" required className={`inputlo ${emailclass ? 'c2' : 'c1'}`} onChange={(event) => { valemail(event.target.value) }} />
                        {/* <label className="labello">Email Address</label> */}
                    </div>
                    <div className="field">
                        <input type={logintogglePassword ? 'password' : 'text'} name="loginpassword" value={password} placeholder="Password eg. Abc@1234" autoComplete="off" required className={`inputlo ${passwordclass ? 'c2' : 'c1'}`} onChange={(event) => { valpassword(event.target.value) }} />
