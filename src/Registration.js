            ...
            <div className="flex w-[200%]">
              ...
              <div className="w-[50%] ease-in-out duration-[0.3s] transition-[margin-left] md:p-[2vh_2vw]">
                ...
                <div className="md:w-full w-[95%] md:h-[7vh] h-[45px] relative flex items-center justify-around m-auto" style={{ margin: '6px 0 0' }}>
                  <div className="md:w-full w-[95%] md:h-[7vh] h-[45px] relative flex items-center justify-around m-auto">
                    <button className="active:scale-[0.9] tracking-[1px] uppercase w-fit xl:p-[0_2vw] p-[0_30px] bg-backgroundcolor md:rounded-[2vw] rounded-[20px] shadow-[inset_5px_5px_15px_#96969680,inset_-5px_-5px_15px_#00000080,3px_3px_5px_#000000b3]" onClick={(event) => { event.preventDefault(); setslidePage(0) }}><div style={{ transform: `rotateY(180deg)` }}><i className="tkd3-next3"></i></div></button>
                  </div>
                  <div className="md:w-full w-[95%] md:h-[7vh] h-[45px] relative flex items-center justify-around m-auto">
                    <button className="active:scale-[0.9] tracking-[1px] uppercase w-fit xl:p-[0_2vw] p-[0_30px] bg-backgroundcolor md:rounded-[2vw] rounded-[20px] shadow-[inset_5px_5px_15px_#96969680,inset_-5px_-5px_15px_#00000080,3px_3px_5px_#000000b3]" onClick={(event) => { submitbutton(event, 2) }}>Sign Up</button>
                  </div>
                </div>
              </div>
            </div>
